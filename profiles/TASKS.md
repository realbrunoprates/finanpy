...
**Subtarefas**:
- [X] 8.3.1: Testes de autenticação (signup, login, logout)
- [X] 8.3.2: Testes de CRUD de contas
- [X] 8.3.3: Testes de CRUD de categorias
- [X] 8.3.4: Testes de CRUD de transações
- [X] 8.3.5: Testes de dashboard
- [X] 8.3.6: Testes de perfil
- [X] 8.3.7: Testar permissões de acesso
